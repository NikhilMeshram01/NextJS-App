...
function Contact() {
    ...
    return (
        <>
            <section className="hidden sm:block relative w-full py-16 sm:py-20 md:py-24 style={{ height: '200vh' }}">
                {/* Contact Section */}
            ...
            {/* Mobile Version (Hidden on Laptop/Desktop) */}
            <div className="block md:hidden">
                <div className="style={{ backgroundImage: ' url('/images/img_.png')'}} w-full px-4 py-8 bg-accent rounded-[20px] m-1">
                    {/* Character Image */}
                    ...
                    <div className="text-center mb-6">
                        <h2 className="text-[24px] font-bold text-white uppercase">Contact Us</h2>
                        <p className="text-[12px] font-normal text-white mt-2 leading-relaxed">
                            Talk with us to know how we can make you a <br />
                            part of a thriving digital landscape
                        </p>
                    </div>

                    {/* Contact Info */}
                    <div className="bg-success-light rounded-xl p-4 mb-6">
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <img src="/images/img_phone.svg" alt="Phone" className="w-5 h-5" />
                                    <span className="text-[12px] text-white">Phone</span>
                                </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <img src="/images/img_mail.svg" alt="Email" className="w-5 h-5" />
                    ...
                    <div className="bg-light rounded-[20px] p-6">
                        <h3 className="text-[20px] font-semibold text-primary mb-4">Let us talk!</h3>
                        <form className="flex flex-col gap-4">
                            <input
                                placeholder="Your Name"
                                className="bg-white-transparent rounded p-2 text-sm"
                            />
                            <input
                            ...
                            <Button
                                ...
                                variant="dark"
                                size="sm"
                                className="text-white rounded-[28px] capitalize mt-2"
                                fullWidth
                            >
                                Send request
                            </Button>
