...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({
  ...
  const variants = {
    primary: 'bg-btn-primary text-white hover:bg-blue-700 active:bg-blue-800 focus:ring-blue-500',
    secondary: 'bg-btn-secondary text-gray-800 hover:bg-gray-300 active:bg-gray-400 focus:ring-gray-300',
  ...
  const responsiveRadius = 'rounded-3xl sm:rounded-3xl md:rounded-3xl';
